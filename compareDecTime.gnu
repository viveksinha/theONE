...
plot newhistogram "", '1.2dectime.txt' using 2:xtic(1) t "1.2" lc rgb "blue",'2.1dectime.txt' using 2:xtic(1) t "2.1" lc rgb "red",'2.2dectime.txt' using 2:xtic(1) t "2.2" lc rgb "green";
